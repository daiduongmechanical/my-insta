    ...
    <div className={cx("wrapper__all")}>
      ...
      <div className={cx("comment")}>
        <div className={cx("select")}>
          <span className={cx("iconw")}>
            <FontAwesomeIcon icon={faHeart} />
          </span>
          <span className={cx("iconx")} onClick={() => setShow(true)}>
            <FontAwesomeIcon icon={faComment} />
          </span>
          <span className={cx("icony")}>
            <FontAwesomeIcon
              onClick={() => setShowShare(true)}
              icon={faShare}
            />
          </span>
          <span className={cx("iconz")}>
        ...
        {view && (
          <Fragment>
            ...
            <p onClick={() => setShow(true)} className={cx("displaycmt")}>
              xem tat ca comment
            </p>
