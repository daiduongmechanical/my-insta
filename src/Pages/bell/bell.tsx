  ...
  return (
    <div className={cx("wrapper")}>
      <div className={cx("overlay")}>
          ...
          <div className={cx("comments")}>
            <div className={cx("info")}>
              <img
                ...
                src="https://images.unsplash.com/photo-1449426468159-d96dbf08f19f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8bW90b3JiaWtlfGVufDB8fDB8fHww&w=1000&q=80"
                alt="bike"
              />
              ...
              <p className={cx("icon")} onClick={() => setEllip(true)}>
                <FontAwesomeIcon icon={faEllipsis} />
              </p>
            </div>
            <div className={cx("comment")}>
              {arr.map((e) => (
                <SuggestItem comment key={e} />
              ))}
            </div>
        ...
        <h1 className={cx("icon_close")} onClick={handle}>
